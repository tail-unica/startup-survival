...
Nothing here touches ``data/raw``: what is being checked is the reading policy —
no type inference, projection, quoted free text — not the content of an
extraction.
"""
